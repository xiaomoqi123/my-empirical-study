...
import src.Modules.progressbar.progressbar as progressbar
import src.Modules.progressbar.widgets as progressbar_widgets
...
def ListFiles(Directory, Extension):
    ...
    if type(Directory) == list:
        ...
        for Directory in Directories:
                filenames = os.listdir(Directory)#Directory has many files
                for filename in filenames:
                    #list filenames 
                    #get the absolute path for the files
